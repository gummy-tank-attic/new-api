...
const keys = {
  ...
  'pricingGroupIntro.claudePlusPremium': {
    ...
    'zh-TW': 'Claude 更優質的第三方渠道，可平替官方 Max，建議在 Sale 分組不穩定時切換使用。',
  ...
  'pricingGroupIntro.claudeMaxCliOnly': {
    ...
    'zh-TW': 'Claude 官方 Max 滿血版，僅限 Claude Code（CLI）使用；如需使用 Claude Desktop，請切換至外接分組。',
  ...
  'pricingGroupIntro.claudeMaxExternal': {
    ...
    'zh-TW': 'Claude 官方 Max 滿血版，可在 Claude Desktop 使用，也能適配更多場景。',
  ...
  'pricingGroupIntro.codexProCodexOnly': {
    ...
    'zh-TW': 'ChatGPT 正價 Pro 號池，僅限在 Codex APP 與 Codex CLI 上使用，不支援外接。',
  ...
  'pricingGroupIntro.codexProExternal': {
    ...
    'zh-TW': 'ChatGPT 正價 Pro 號池，不僅能在 Codex 客戶端使用，支援外接腳本與生圖。',
  ...
  'pricingGroupIntro.grokBeta': {
    ...
    'zh-TW': 'Grok 4.5 速度快、智商高、限制少，完全媲美 Opus 4.8，推薦用於編碼。【測試分組可能不穩定，不建議用於生產環境】',
