...
export const STATIC_I18N_KEYS = [
  ...
  'Group price = baseline × group ratio',
  'Official prices use $1 = {{symbol}}{{rate}}',
  'Official prices use the site model baseline (ratio 1.0)',
  'Official price is the site baseline after ratio sync, not a live fetch.',
  'Select a group to view prices',
  'Price mode',
  'Group intro',
  ...
  'pricingGroupIntro.seedance',
  'No pricing groups available for this vendor',
  'Pricing groups',
  'Search model name...',
  'Model ID',
  'Savings',
  ...
  'Vendors',
  'Upscale Principle',
  'Deep Learning & Detail Reconstruction',
  ...
  'Upscale Image Reconstruction',
  'Upscale Service · Video Tokens $7.18/1M+',
  'Billing formula: Charge = Video Tokens + Duration × Upscale Rate',
  'Upscale (/s)',
  'Video (/1M)',
  'Unit: / 1M Tokens',
